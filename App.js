...
function HomeScreen({ initializedDB, setInitializedDB }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1 }}>
        ...
        >
          <TouchableOpacity onPress={exportData} style={{ marginLeft: 10 }}>
            <Image
              source={icons.upload}
              resizeMode="contain"
          ...
          <TouchableOpacity onPress={importData} style={{ marginLeft: 10 }}>
            <Image
...
export default function App() {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      {/* Set status bar background color and content color */}
